...
- `functions/random.js` - A balanced random function based on `Math.random()` where boundary values are equally probable
- `functions/christmas-tree.js` - The famous Christmas tree exercise
